...
public class MagmaCubeData extends CreatureData {
	...
	public void setOn(Entity mob, Player owner) {
		if (mob instanceof MagmaCube) {
			...
			if (MagmaCubeSize != null) z.setSize(MagmaCubeSize);
	...
	public boolean matches(Data d) {
		if(!(d instanceof MagmaCubeData)) return false;
		MagmaCubeData vd = (MagmaCubeData)d;

		if (this.MagmaCubeSize != null)
			if (this.MagmaCubeSize != vd.MagmaCubeSize) return false;
	...
	public static CreatureData parseFromString(String state) {
		...
		if (!state.isEmpty() && !state.equals("0")) {
			...
			for (String sub : split) {
				...
				if(sub.equalsIgnoreCase("TINY")) MagmaCubeSize = 1;
				else if(sub.equalsIgnoreCase("SMALL")) MagmaCubeSize = 2;
				else if(sub.equalsIgnoreCase("BIG")) MagmaCubeSize = 3;
				else if(sub.equalsIgnoreCase("HUGE")) MagmaCubeSize = 4;
			}
		}
	...
	public String toString() {
		...
		if (MagmaCubeSize != null) {
			...
			if (MagmaCubeSize == 0 || MagmaCubeSize == 1) MagmaCubeSizeMsg = "TINY";
			else if (MagmaCubeSize == 2) MagmaCubeSizeMsg = "SMALL";
			else if (MagmaCubeSize == 3) MagmaCubeSizeMsg = "BIG";
			else if (MagmaCubeSize == 4) MagmaCubeSizeMsg = "HUGE";
