...
public class WolfData extends CreatureData {
	...
	public void setOn(Entity mob, Player owner) {
		if (mob instanceof Wolf) {
			...
			if (tamed != null) if (tamed) z.setOwner(owner);
