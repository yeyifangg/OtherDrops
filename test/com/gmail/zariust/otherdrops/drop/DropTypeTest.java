...
public class DropTypeTest {
	...
	private void testSplit(String testVal, String amountShouldBe, String chanceShouldBe) {
		...
		assertTrue("Error, chance ("+chance+") is not '"+chanceShouldBe+"'.", chance.equalsIgnoreCase(chanceShouldBe));
		assertTrue("Error, amount ("+amount+") is not '"+amountShouldBe+"'.", amount.equalsIgnoreCase(amountShouldBe));
	...
	public void testParse() {
		...
		testParseMob("zombie@baby!!VILLAGER!!50h", "CREATURE_ZOMBIE@!!VILLAGER!!BABY%50h", "", "");
		testParseMob("zombie@baby!!VILLAGER!!50H", "CREATURE_ZOMBIE@!!VILLAGER!!BABY%50h", "", "");
		testParseMob("zombie@baby!!VILLAGER!!50Hp", "CREATURE_ZOMBIE@!!VILLAGER!!BABY%50h", "", "");
		testParseMob("zombie@baby!!VILLAGER!!50HP", "CREATURE_ZOMBIE@!!VILLAGER!!BABY%50h", "", "");
	}
	...
	private void testParseMob(String testVal, String name, String data, String lorename) {
		System.out.println("Test parse: '"+testVal+"'");
		DropType split = DropType.parse(testVal, "");
		assertTrue("Error, mat ("+split.getName()+") is not '"+name+"'.", split.getName().equalsIgnoreCase(name));
